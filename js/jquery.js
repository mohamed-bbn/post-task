...
! function(C) {
    ...
    C.breakingNews = function(t, e) {
        var i = { effect: "scroll", direction: "ltr", height: 40, fontSize: "default", themeColor: "default", background: "default", borderWidth: 1, radius: 2, source: "html", rss2jsonApiKey: "", play: !0, delayTimer: 4e3, scrollSpeed: 2, stopOnHover: !0, position: "auto", zIndex: 99999 },
            o = this;
        o.settings = {};
        var s = C(t),
            ...
            b = !1,
            y = function() {
                if (0 < n.length && ("rtl" == o.settings.direction ? l.css({ right: n.outerWidth() }) : l.css({ left: n.outerWidth() })), 0 < r.length) { var t = r.outerWidth(); "rtl" == o.settings.direction ? l.css({ left: t }) : l.css({ right: t }) }
            ...
            x = function() {
                switch (p = !0, o.settings.effect) {
                    ...
                    case "fade":
                        ...
                        break;
                    case "slide-down":
                        m <= 1 ? c.find("li").animate({ top: 30, opacity: 0 }, 300, function() { C(this).css({ top: -30, opacity: 0, display: "block" }), C(this).animate({ top: 0, opacity: 1 }, 300) }) : (c.find("li:visible").animate({ top: 30, opacity: 0 }, 300, function() { C(this).hide() }), c.find("li").eq(a).css({ top: -30, opacity: 0 }).show(), c.find("li").eq(a).animate({ top: 0, opacity: 1 }, 300));
                        break;
                    case "slide-up":
                        m <= 1 ? c.find("li").animate({ top: -30, opacity: 0 }, 300, function() { C(this).css({ top: 30, opacity: 0, display: "block" }), C(this).animate({ top: 0, opacity: 1 }, 300) }) : (c.find("li:visible").animate({ top: -30, opacity: 0 }, 300, function() { C(this).hide() }), c.find("li").eq(a).css({ top: 30, opacity: 0 }).show(), c.find("li").eq(a).animate({ top: 0, opacity: 1 }, 300));
                        break;
                    case "slide-left":
                        m <= 1 ? c.find("li").animate({ left: "50%", opacity: 0 }, 300, function() { C(this).css({ left: -50, opacity: 0, display: "block" }), C(this).animate({ left: 0, opacity: 1 }, 300) }) : (c.find("li:visible").animate({ left: "50%", opacity: 0 }, 300, function() { C(this).hide() }), c.find("li").eq(a).css({ left: -50, opacity: 0 }).show(), c.find("li").eq(a).animate({ left: 0, opacity: 1 }, 300));
                        break;
                    case "slide-right":
                        m <= 1 ? c.find("li").animate({ left: "-50%", opacity: 0 }, 300, function() { C(this).css({ left: "50%", opacity: 0, display: "block" }), C(this).animate({ left: 0, opacity: 1 }, 300) }) : (c.find("li:visible").animate({ left: "-50%", opacity: 0 }, 300, function() { C(this).hide() }), c.find("li").eq(a).css({ left: "50%", opacity: 0 }).show(), c.find("li").eq(a).animate({ left: 0, opacity: 1 }, 300));
                        break;
